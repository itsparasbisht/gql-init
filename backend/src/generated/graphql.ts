...
export type ResolversTypes = ResolversObject<{
  ...
  OrderItem: ResolverTypeWrapper<
    Omit<OrderItem, "product"> & { product: ResolversTypes["Product"] }
  >;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Order: IOrder;
  OrderItem: Omit<OrderItem, "product"> & {
...
> = ResolversObject<{
  addCategory?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAddCategoryArgs, "name">
  >;
  addProduct?: Resolver<
  ...
  updateProduct?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<MutationUpdateProductArgs>
  >;
}>;
...
export type ReviewResolvers<
  ContextType = IContext,
  ParentType extends ResolversParentTypes["Review"] =
